...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/minimist</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/minimist.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/minimist.git</developerConnection>
        <url>github.com/scalajs-io/minimist.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
